...
export const resourceCommentRelations = relations(
	resourceComment,
	({ one }) => ({
		resource: one(resource, {
			fields: [resourceComment.resourceId],
			references: [resource.id],
		}),
		author: one(user, {
			fields: [resourceComment.authorId],
			references: [user.id],
		}),
	}),
);
...
export const resourceRatingRelations = relations(resourceRating, ({ one }) => ({
	resource: one(resource, {
		fields: [resourceRating.resourceId],
		references: [resource.id],
	}),
